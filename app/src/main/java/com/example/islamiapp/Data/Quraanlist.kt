...
object Quraanlist {
    ...
    private val numberOfVerses = listOf(
        ...
        "20", "15", "21", "11", "8", "8", "19", "5", "8", "11", "11", "8", "3", "9",
        "5", "4", "7", "3", "6", "3", "5", "4", "5", "6","6"
    )


    val ListSoraFilled= mutableListOf<Sora>()
    fun fillQuraanList() {
        for (index in 0 until nameListAr.size ) {
            ListSoraFilled.add(
                Sora(
                    nameListAr[index],
                    nameListEn[index],
                    numberOfVerses[index]
                )
            )
        }
        }
